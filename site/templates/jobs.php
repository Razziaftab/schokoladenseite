	...
	<body class="page-blog">
		...
		<main id="main">
			...
			<?php if($page->children()->listed()->count() > 0): ?>
				<div class="news row">
					<h2 id="online-news">Aktuelle Jobangebote</h2>

					<div class="blog blog-home">
						<?php
							$listeditems = $page->children()->listed()->filter(function ($child) {
								return $child->date()->toDate() < time();
							});
						?>				

						<?php foreach ($listeditems->sortBy("datetoday", "desc", 'date', 'desc') as $item): ?>
